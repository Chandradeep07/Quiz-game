<template>
  <div id="quiz-container">
    <img id="logo-crown" src="@/assets/download-removebg-preview.png" alt="headsUP Crown" />
    <h1 id="logo-headline">KBC!</h1>
...
.divider {
  margin: 0.5rem 0;
  border: 3px solid rgba(5, 150, 65, 0.7);
  border-radius: 2px;
